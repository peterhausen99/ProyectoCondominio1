...
@Component({
  selector: 'app-asignacionplan-admin',
  templateUrl: './asignacionplan-admin.component.html',
  styleUrls: ['./asignacionplan-admin.component.css']
})
export class AsignacionplanAdminComponent implements OnInit{
